...
class ToolRegistry:
    ...
    def set_document_scope(self, document_ids: Optional[set]) -> None:
        ...
        if document_ids is not None:
            ...
            print(f"[ToolRegistry] Document scope set: {len(self._document_scope)} documents")
        else:
            self._document_scope = None
            print("[ToolRegistry] Document scope cleared (all documents)")
    ...
    def clear_document_scope(self) -> None:
        ...
        self._document_scope = None
        print("[ToolRegistry] Document scope cleared")
